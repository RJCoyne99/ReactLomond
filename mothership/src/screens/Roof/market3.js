...
export default function Market3(props){
    return (
      ...
      <View style={S.container}>
        ...
        <View style={S.mainContainerLight}>
           ...
           <View style={[S.flexRow, { justifyContent: 'center', alignItems: 'center', marginTop: -280}]}>  
            <Image source={O.ROOFING.IMAGES.MARKET3} style={S.imageFullWidth} />
            </View>
          

        </View>

        <Footer previousPage={N.ROOFING[13]} currentPage={N.ROOFING[14]} nextPage={N.ROOFING[15]} pageChange={(pageNum) => props.pageChange(pageNum)} />
