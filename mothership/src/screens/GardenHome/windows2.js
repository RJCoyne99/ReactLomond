...
function NumberOfWindows(props) {
  const [numberOfWindows, setNumberOfWindows] = React.useState("");
  return (
    <View style={styles.container}>
      ...
      {/* </View> */}
      <Text style={styles.gardenHomes}>How many windows?</Text>
      {/* </View> */}
      ...
      <ScrollView style={{ width: "100%", paddingTop: 76 }}>
        ...
        >
          ...
          >
            <Text style={{ textAlign: "center" }}>
              ENTER DESIRED NUMBER OF WINDOWS
            </Text>
            <TextInput
              style={styles.input}
              onChangeText={(newNumber) => setNumberOfWindows(newNumber)}
            ></TextInput>
          </View>
        ...
        >
          ...
          <TouchableOpacity
            onPress={() => {
              props.setContract(numberOfWindows);
              props.pageChange(9);
            }}
            style={{ marginHorizontal: 20 }}
          >
...
export default NumberOfWindows;
